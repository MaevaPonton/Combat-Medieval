...
class Archer extends Hero {
    ...
    {
        if ($monster instanceof Ogre) { // instanceof vérifie si un objet est une instance d'une certaine classe
            $damage = rand(0, 25) * 2; // inflige deux fois plus de dégâts contre un ogre
        } else {
